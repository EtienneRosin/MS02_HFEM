...
from hfem.poisson_problems.solvers.standard.periodic import PeriodicConfig, PeriodicProblem
...
if __name__ == '__main__':
    ...
    plot_convergence_from_csv(
        csv_path="convergence_results/periodic_convergence_results.csv",
        save_name="convergence_results/periodic_convergence_results")