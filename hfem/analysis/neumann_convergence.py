...
from hfem.poisson_problems.solvers.standard.neumann import NeumannHomogeneousProblem, NeumannConfig
...
if __name__ == '__main__':
    ...
    plot_convergence_from_csv(
        csv_path="convergence_results/neumann_convergence_results.csv",
        save_name="convergence_results/neumann_convergence_results")