...
class PoissonPeriodicProblem(PoissonNeumannProblem):
...
if __name__ == "__main__":
    ...
    h = 0.025
    rectangular_mesh(h = h, L_x = 2, L_y = 1, save_name = mesh_fname)
    ...
    periodic_pb = PoissonPeriodicProblem(mesh = mesh, diffusion_tensor = diffusion_tensor, rhs = f, exact_solution = u)
