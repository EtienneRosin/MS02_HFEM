from hfem.problems import PeriodicPoissonProblem, BasePoissonConfig
...
if __name__ == '__main__':
    data = measure_convergence(
        problem=PeriodicPoissonProblem,
    ...
    data = read_from_file(filepath=f"{save_dir}/convergence_periodic.csv")
    
    plot_convergence(data, save_name=f"{save_dir}/convergence_periodic")