from hfem.problems import HomogenousNeumannPoissonProblem, BasePoissonConfig
...
if __name__ == '__main__':
    data = measure_convergence(
        problem=HomogenousNeumannPoissonProblem,
    ...
    data = read_from_file(filepath=f"{save_dir}/convergence_neumann.csv")
    
    plot_convergence(data, save_name=f"{save_dir}/convergence_neumann")