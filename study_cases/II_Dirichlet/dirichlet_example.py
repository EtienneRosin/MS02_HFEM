...
if __name__ == '__main__':
    ...
    neumann_pb = HomogenousDirichletPoissonProblem(mesh, pb_config)
    ...
    neumann_pb.display_solution(
        solution_config(
            kind='trisurface',
            save_name = f'study_cases/II_Dirichlet/dirichlet_solution.pdf'
        )
    )
    plt.show()
    ...
    neumann_pb.display_error(
        error_config(
            ...
            cbar = True,
            save_name = f'study_cases/II_Dirichlet/dirichlet_absolute_error.pdf'
        )
    )
    plt.show()
